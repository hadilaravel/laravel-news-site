...
use Modules\Panel\App\Policies\PanelPolicy;
...
class PanelServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Blade::directive('permission' , function ($permission){
            return "<?php
             if (auth()->check() && auth()->user()->hasPermissionTo($permission) || auth()->user()->hasPermissionTo(\Modules\Role\App\Models\Permission::PERMISSION_SUPER_ADMIN) ) {
            ?>";
        });
