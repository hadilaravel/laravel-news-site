                     ...
                     <section class="col-12 ">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="type" id="" class="form-control form-control-sm" id="type">
                                    <option value="0" @if(old('type') == 0) selected @endif>عادی</option>
                                    <option value="1" @if(old('type') == 1) selected @endif> ویژه</option>
                                </select>
                            </div>
                            @error('type')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="type_text" id="" class="form-control form-control-sm" id="type_text">
                                    <option value="0" @if(old('type_text') == 0) selected @endif>متنی</option>
                                    <option value="1" @if(old('type_text') == 1) selected @endif> ویدیو</option>
                                </select>
                            </div>
                            @error('type_text')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="time_to_read" value="{{ old('time_to_read') }}" class="form-control form-control-sm">
                            </div>
                            @error('time_to_read')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
