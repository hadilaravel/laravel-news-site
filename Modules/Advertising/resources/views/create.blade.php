...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page">ایجاد  تبلیغ جدید  </li>
    </ol>
  </nav>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="link" value="{{ old('link') }}" class="form-control form-control-sm">
                            </div>
                            @error('link')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
